<?php use Module\Tasklist\View\SRC\Template\Site as View_Site; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title><?= View_Site::getPageTitle() ?> | Tasklist</title>
    <!-- Font Awesome -->
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
        <div class="container-fluid">
            ...
            <a class="navbar-brand waves-effect" href="/" target="_blank">
                <strong class="blue-text">Tasklist</strong>
            </a>
            <!-- Collapse -->
